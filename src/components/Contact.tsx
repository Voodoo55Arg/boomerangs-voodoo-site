      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div>
            ...
            <h2 className="reveal reveal-d1 font-display font-extrabold uppercase leading-none mb-8"
            ...
            <div className="reveal reveal-d3">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-brand-sand/50 text-xs">+54 9 351 801-9893</div>
                </div>
              </a>
            </div>
          </div>
          ...
          <div className="reveal reveal-d2">
            {sent ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full bg-red-600 text-white p-3"
                >
                  Enviar
                </button>
              </form>
